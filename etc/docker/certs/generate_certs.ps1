...
Export-PfxCertificate -Cert $rootCA -FilePath WalsunErp-root-cert.pfx -Password $password | Out-Null
...
Export-Certificate -Cert $rootCA -FilePath WalsunErp-root-cert.cer -Type CERT | Out-Null
