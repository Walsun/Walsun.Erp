...
(function(){
  ...
  // controller Walsun.Erp.basketService.basket

  (function(){

    abp.utils.createNamespace(window, 'Walsun.Erp.basketService.basket');

    Walsun.Erp.basketService.basket.get = function(anonymousUserId, ajaxParams) {
    ...
    Walsun.Erp.basketService.basket.addProduct = function(input, ajaxParams) {
      return abp.ajax($.extend(true, {
    ...
    Walsun.Erp.basketService.basket.removeProduct = function(input, ajaxParams) {
      return abp.ajax($.extend(true, {
