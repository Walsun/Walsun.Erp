...
public class PaymentCompletedModel : AbpPageModel
{
    ...
    {
        if (!HttpContext.Request.Cookies.TryGetValue(WalsunErpPaymentConsts.PaymentMethodCookie,
        ...
        if (IsSuccessful)
        {
            ...
            HttpContext.Response.Cookies.Delete(WalsunErpPaymentConsts.PaymentMethodCookie);
